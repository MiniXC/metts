...
def main(index):
    ...
    model = FastSpeechWithConsistency.from_pretrained("output/checkpoint-54000", consistency_net=consistency_net, ignore_mismatched_sizes=True) # (MeTTSConfig(), consistency_net=consistency_net)
